	...
	return (
		<section className="flex flex-col mt-10">
			...
			<div className="grid grid-cols-1 md:grid-cols-6 gap-0">
				<StackSection className="bg-gray-400 dark:bg-gray-100">
